...
Main.prototype = {
    preload: function(){
        ...
        game.load.image('buttonA', 'assets/img/buttonA.png');
        game.load.image('buttonS', 'assets/img/buttonS.png');
        game.load.image('buttonF', 'assets/img/buttonF.png');
        game.load.image('buttonE', 'assets/img/buttonE.png');
        game.load.image('buttonB', 'assets/img/buttonB.png');
        game.load.image('buttonG', 'assets/img/buttonG.png');
        game.load.image('buttonSPACE', 'assets/img/buttonSpace.png');
